CREATE OR REPLACE PROCEDURE tax_discounts_proc() 
AS $$
	BEGIN 
	DROP table IF EXISTS analytics.tax_discounts;
	CREATE TABLE analytics.tax_discounts AS 
 (
